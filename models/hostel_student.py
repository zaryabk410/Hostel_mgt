...
class HostelStudent(models.Model):
    ...
    room_name = fields.Char("Room Name", related="room_id.name", store=True)
    room_availability = fields.Float("Room Availability", related="room_id.availability", store=True)
